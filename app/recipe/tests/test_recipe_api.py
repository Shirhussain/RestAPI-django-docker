...
class RecipeImageUploadTests(TestCase):
    ...
    def test_filter_recipe_by_tags(self):
        ...
        recipe1 = sample_recipe(user=self.user, title='Qoroti with roghan zard')
        recipe2 = sample_recipe(user=self.user, title='Kashkew va ash')
        tag1 = sample_tag(user=self.user, name='Nan')
        tag2 = sample_tag(user=self.user, name='peyaz')
        recipe1.tags.add(tag1)
        recipe2.tags.add(tag2)
        recipe3 = sample_recipe(user=self.user, title='bosragh and job josh')
    ...
    def test_recipe_by_ingredients(self):
        ...
        recipe1 = sample_recipe(user=self.user, title="Mantoo with ashak")
        recipe2 = sample_recipe(user=self.user, title='Nanter javari')
        ingredient1 = sample_ingredient(user=self.user, name='ash reshta')
        ingredient2 = sample_ingredient(user=self.user, name='dogh vatani')
        recipe1.ingredients.add(ingredient1)
        recipe2.ingredients.add(ingredient2)
        recipe3 = sample_recipe(user=self.user, title='Ab gosht')
